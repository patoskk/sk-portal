    ...
    <div ref={ref} style={{ position: "relative" }}>
      ...
      {open && (
        ...
        >
          ...
          {/* Los avisos de lecciones no se dan de baja desde el portal: son parte
              del servicio. Si un cliente pide no recibirlos, se apaga a mano
              (clients.notify_lessons = false) y getLessonRecipients lo saltea. */}
